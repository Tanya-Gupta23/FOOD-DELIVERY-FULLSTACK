...
function CheckOut() {
    ...
    const getLatLngByAddress = async () => {
        try {
            ...
            dispatch(setLocation({ lat: result.data.features[0].properties.lat, lon: result.data.features[0].properties.lon }))
        } catch (error) {
            console.log(error)
        ...
        <div className="min-h-screen bg-[#fff9f6] flex items-center justify-center p-6">
            ...
            <div className="w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6">
                ...
                <section>
                    ...
                    <div className="flex gap-2 mb-3">
                        <input type="text" className="flex-1 border border-gray-300 rounded-lg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff4d2d]"
                            placeholder="Enter your delivery addresss" value={addressInput} onChange={(e) => setAddressInput(e.target.value)} />
                        <button className="bg-[#ff4d2d] hover:bg-[#e64526] text-white px-3 py-2 rounded-lg flex items-center justify-center" onClick={getLatLngByAddress}><FaSearch /></button>
                ...
                <button className="w-full bg-[#ff4d2d] hover:bg-[#e64526] text-white py-3 rounded-xl font-semibold" onClick={handlePlaceOrder}>
                 ...
                 {/*What can we send to the controller
